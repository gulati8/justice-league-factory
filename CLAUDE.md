...
| Martian Manhunter | Planner | Read, Glob, Grep, Write | planning-methodology, product-thinking, architectural-principles, database-patterns, frontend-patterns, infrastructure-patterns | .factory-run/plan.json + architecture.md |
